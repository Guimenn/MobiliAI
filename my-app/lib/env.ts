export const env = {
  ...
  // MQTT
  MQTT_BROKER: process.env.NEXT_PUBLIC_MQTT_BROKER || '10.84.6.135',
  MQTT_WS_PORT: process.env.NEXT_PUBLIC_MQTT_WS_PORT || '9001',
  MQTT_TOPIC_RFID: process.env.NEXT_PUBLIC_MQTT_TOPIC_RFID || 'palmieri/tag',
};
